...
APP_NAME="z-biz-tool-file"           # .app bundle 名称 (来自 tauri.conf.json productName)
BUNDLE_ID="com.zifang.z-biz-tool-file"  # bundle identifier
DISPLAY_NAME="z-biz-tool-file"
